...
function resolveCatalogRoot(): string {
  const candidates = [
    process.env.BIRTHUB_AGENT_PACKS_DIR,
    path.join(process.cwd(), "packages", "agent-packs"),
    path.join(process.cwd(), "..", "..", "packages", "agent-packs"),
    path.join(process.cwd(), "..", "packages", "agent-packs"),
    path.join(process.cwd(), "imports", "nova-proposta", "packages", "agent-packs"),
    path.join(process.cwd(), "..", "..", "imports", "nova-proposta", "packages", "agent-packs"),
    path.join(process.cwd(), "..", "imports", "nova-proposta", "packages", "agent-packs")
...
class MarketplaceService {
  ...
  async getApprovalStats(agentIds: string[], tenantId?: string | null) {
